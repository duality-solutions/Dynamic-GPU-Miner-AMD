...
struct opt_table opt_config_table[] = {
  ...
  OPT_WITH_ARG("--intensity|-I",
      ...
      " -> " MAX_INTENSITY_STR"). More intensity means more meory usage. Combine this with -g to utilize more of the device available memory") ,
...
bool submit_tested_work(struct thr_info *thr, struct work *work)
{
  ...
  else if (work->pool->algorithm.type == ALGO_ARGON2D) {
