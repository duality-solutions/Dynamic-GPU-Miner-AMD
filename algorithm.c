...
static cl_int queue_argon2d_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
    ...
    // init - search
    clSetKernelArg(clState->kernel, 0, sizeof(cl_mem), (void *)&clState->buffer1);
    clSetKernelArg(clState->kernel, 1, sizeof(cl_mem), (void *)&clState->CLbuffer0);
    ...
    clSetKernelArg(clState->extra_kernels[0], 1, sizeof(clState->buffer1), (void *)&clState->buffer1);
    ...
    clSetKernelArg(clState->extra_kernels[1], 0, sizeof(clState->buffer1), (void *)&clState->buffer1);
    clSetKernelArg(clState->extra_kernels[1], 1, sizeof(clState->outputBuffer), (void *)&clState->outputBuffer);
    clSetKernelArg(clState->extra_kernels[1], 2, smem, NULL);
